...
namespace NewStarterProject.NewStarter.Infrastructure.Datastore;

public partial class StarterProjectContext : DbContext, IDataStore
{
    ...
    // Delegate the SaveChangesAsync method to the base class
